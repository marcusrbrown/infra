...
export function getGatewayDeployEnv(): Record<string, string> {
  ...
  return {
    ...
    GATEWAY_OPERATOR_BIND_HOST: process.env.GATEWAY_OPERATOR_BIND_HOST ?? '',
    GATEWAY_OPERATOR_BIND_PORT: process.env.GATEWAY_OPERATOR_BIND_PORT ?? '',
    GATEWAY_OPERATOR_PUBLIC_ORIGIN: process.env.GATEWAY_OPERATOR_PUBLIC_ORIGIN ?? '',
    GATEWAY_OPERATOR_GITHUB_CLIENT_ID: process.env.GATEWAY_OPERATOR_GITHUB_CLIENT_ID ?? '',
    GATEWAY_OPERATOR_GITHUB_CLIENT_SECRET: process.env.GATEWAY_OPERATOR_GITHUB_CLIENT_SECRET ?? '',
    GATEWAY_OPERATOR_CSRF_SECRET: process.env.GATEWAY_OPERATOR_CSRF_SECRET ?? '',
    GATEWAY_OPERATOR_ALLOWLIST: process.env.GATEWAY_OPERATOR_ALLOWLIST ?? '',
    GATEWAY_OPERATOR_OAUTH_ALLOWED_RETURN_PATHS: process.env.GATEWAY_OPERATOR_OAUTH_ALLOWED_RETURN_PATHS ?? '',
    GATEWAY_OPERATOR_OAUTH_STATE_TTL_MS: process.env.GATEWAY_OPERATOR_OAUTH_STATE_TTL_MS ?? '',
    GATEWAY_OPERATOR_OAUTH_MAX_OUTSTANDING_ATTEMPTS: process.env.GATEWAY_OPERATOR_OAUTH_MAX_OUTSTANDING_ATTEMPTS ?? '',
    GATEWAY_OPERATOR_PUSH_VAPID_PUBLIC_KEY: process.env.GATEWAY_OPERATOR_PUSH_VAPID_PUBLIC_KEY ?? '',
    GATEWAY_OPERATOR_PUSH_VAPID_PRIVATE_KEY: process.env.GATEWAY_OPERATOR_PUSH_VAPID_PRIVATE_KEY ?? '',
    GATEWAY_OPERATOR_PUSH_VAPID_SUBJECT: process.env.GATEWAY_OPERATOR_PUSH_VAPID_SUBJECT ?? '',
    GATEWAY_OPERATOR_PUSH_VAPID_KEY_VERSION: process.env.GATEWAY_OPERATOR_PUSH_VAPID_KEY_VERSION ?? '',
